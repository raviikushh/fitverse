  ...
  return (
    <div>
        ...
        <div className="hero py-12 grid grid-cols-1 md:grid-cols-2 gap-4 p-4 md:px-32 bg-gradient-to-r from-green-600 via-green-500 to-green-400 text-white font-semibold mt-20">
                ...
                <DynamicEventForm eventId="Night_Run" price={price} category={selectedCategory} date={'2025-07-15'} message={'Online registration is closed now, for offline registrations please connect on 9304599119 number'}/>
                {/* <Reg/> */}
                {/* <Register6/> */}
            <Contact/>
            <Footer/>
