...
const LandingPage = () => {
    return (
        <div>
            ...
            <body>
                <div className="hero grid grid-cols-1 md:grid-cols-2 gap-4 p-4 md:px-32 bg-gradient-to-r from-black/90 via-black/90 to-orange-900 text-white font-semibold ">
                    <div className="textarea">
                        ...
                        <Button variant="outline" className='bg-black/90 font-semibold text-md hover:text-orange-600 hover:bg-black hover:border-orange-600'>Learn More</Button>
                        </div>
