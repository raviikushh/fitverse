...
const MainPageContact = () => {
    ...
    return (
        <>
            <MainPageNav />
            <div className="contact-page mt-20 px-4 sm:px-6 lg:px-8 bg-black min-h-screen" id="contact">
                <h1 className="text-4xl font-bold text-center pt-10 text-orange-500">
                    Reach Us
                </h1>
                <h1 className="text-3xl font-bold text-center mb-4 pt-6 text-white">
                ...
                <form
                    onSubmit={onSubmit}
                    className="contact-form max-w-4xl mx-auto bg-gray-900 p-8 rounded-lg shadow-lg mb-14"
                >
                    ...
                    <div className="flex justify-between">
                        ...
                        <button
                            ...
                            className="w-full bg-gray-700 text-white py-2 px-4 rounded-md shadow-sm hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 ml-4"
                        >
                            Reset
                        </button>
                    </div>
